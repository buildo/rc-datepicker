...
/***/ function(module, exports, __webpack_require__) {
	...
	var isInsideTheEnabledArea = function isInsideTheEnabledArea(date, minDate, maxDate) {
	  if (!minDate && !maxDate) {
	    return true;
	  }
	  ...
	  render: function render() {
	    ...
	    var months = _moment2['default'].months().map(function (_month, index) {
	      ...
	      return _React2['default'].createElement(_Picker2['default'], {
	        ...
	        isCurrent: true,
	        isEnabled: _DateUtils2['default'].isInsideTheEnabledArea(date, _this.props.minDate, _this.props.maxDate),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Picker = _React2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    var classes = this.props.mode + (this.props.isCurrent ? ' current' : '') + (this.props.isSelected ? ' selected' : '') + (!this.props.isEnabled ? ' disabled' : '');
	    return _React2['default'].createElement(
	      'div',
