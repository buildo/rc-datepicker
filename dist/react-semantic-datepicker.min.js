(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["SemanticDatePicker"] = factory();
	else
		root["SemanticDatePicker"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DatePicker2 = _interopRequireWildcard(_DatePicker);

	var _DatePickerInput = __webpack_require__(2);

	var _DatePickerInput2 = _interopRequireWildcard(_DatePickerInput);

	exports.DatePicker = _DatePicker2['default'];
	exports.DatePickerInput = _DatePickerInput2['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DayPicker = __webpack_require__(3);

	var _DayPicker2 = _interopRequireWildcard(_DayPicker);

	var _MonthPicker = __webpack_require__(4);

	var _MonthPicker2 = _interopRequireWildcard(_MonthPicker);

	var _YearPicker = __webpack_require__(5);

	var _YearPicker2 = _interopRequireWildcard(_YearPicker);
	...
	var DatePicker = _React2['default'].createClass({
	  ...
	  propTypes: {
	    ...
	    date: _React2['default'].PropTypes.oneOfType([_React2['default'].PropTypes.string, _React2['default'].PropTypes.instanceOf(Date)]),
	    initialDate: _React2['default'].PropTypes.oneOfType([_React2['default'].PropTypes.string, _React2['default'].PropTypes.instanceOf(Date)]),
	    minDate: _React2['default'].PropTypes.oneOfType([_React2['default'].PropTypes.string, _React2['default'].PropTypes.instanceOf(Date)]),
	    maxDate: _React2['default'].PropTypes.oneOfType([_React2['default'].PropTypes.string, _React2['default'].PropTypes.instanceOf(Date)]),
	    locale: _React2['default'].PropTypes.string,
	    startMode: _React2['default'].PropTypes.string,
	    fixedMode: _React2['default'].PropTypes.bool,
	  ...
	  getStateFromProps: function getStateFromProps(_props) {
	    var date = typeof _props.date === 'string' ? _moment2['default'](_props.date, this.getFormat(), true) : _moment2['default'](_props.date);
	    var initialDate = typeof _props.initialDate === 'string' ? _moment2['default'](_props.initialDate, this.getFormat(), true) : _moment2['default'](_props.initialDate);
	    var visibleDate = _props.date ? date.clone() : initialDate; // must be copy, otherwise they get linked
	    return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _React = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"react/addons\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var _DateUtils = __webpack_require__(6);

	var _DateUtils2 = _interopRequireWildcard(_DateUtils);

	var _Locales = __webpack_require__(7);

	var _Locales2 = _interopRequireWildcard(_Locales);
	...
	var DatePickerInput = _React2['default'].createClass({
	  ...
	  getInitialState: function getInitialState() {
	    ...
	    var _date = this.props.date || this.props.initialDate;
	    var date = typeof _date === 'string' ? _moment2['default'](_date, this.getFormat(), true) : _moment2['default'](_date);
	    return {
	  ...
	  _onChangeDate: function _onChangeDate(jsDate) {
	    ...
	    var newDateString = newDate.format(this.getFormat());
	  ...
	  onChangeInput: function onChangeInput(dateString) {
	    ...
	    var parsedDate = _moment2['default'](dateString, this.getFormat(dateString), true);
	    if (parsedDate.isValid()) {
	      this.setState({ date: parsedDate });
	    }
	    var jsDate = parsedDate.isValid() ? parsedDate.toDate() : undefined;
	  ...
	  render: function render() {
	    return _React2['default'].createElement(
	      ...
	      _React2['default'].createElement(
	        'div',
	        { className: 'ui action input datepicker-input' },
	        ...
	        _React2['default'].createElement(
	          'div',
	          { className: 'ui icon button' + (this.state.showing ? ' active' : ''), onClick: this.toggleDatePicker },
	  ...
	  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	    if (nextProps.date) {
	      var _date = nextProps.date || nextProps.initialDate;
	      var _date2 = typeof _date === 'string' ? _moment2['default'](_date, this.getFormat(), true) : _moment2['default'](_date);
	      this.setState({
	        date: _date ? _date2 : undefined
	      });
	    }
	  },

	  temporaryHardcodedLocale: function temporaryHardcodedLocale() {
	    _moment2['default'].defineLocale('it', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DayPickerTop = __webpack_require__(11);

	var _DayPickerTop2 = _interopRequireWildcard(_DayPickerTop);

	var _DayPickerBody = __webpack_require__(12);

	var _DayPickerBody2 = _interopRequireWildcard(_DayPickerBody);

	'use strict';

	var DayPicker = _React2['default'].createClass({
	  displayName: 'DayPicker',

	  propTypes: {
	    visibleDate: _React2['default'].PropTypes.any.isRequired,
	    date: _React2['default'].PropTypes.any,
	    onChangeVisibleDate: _React2['default'].PropTypes.func.isRequired,
	    onSelectDate: _React2['default'].PropTypes.func.isRequired,
	    onChangeMode: _React2['default'].PropTypes.func.isRequired,
	  ...
	  render: function render() {
	    return _React2['default'].createElement(
	      'div',
	      { className: this.props.className + ' container day' },
	      _React2['default'].createElement(_DayPickerTop2['default'], {
	        visibleDate: this.props.visibleDate,
	        onChangeVisibleDate: this.props.onChangeVisibleDate,
	        onChangeMode: this.props.onChangeMode,
	        fixedMode: this.props.fixedMode,
	        className: this.props.className }),
	      _React2['default'].createElement(_DayPickerBody2['default'], {
	        visibleDate: this.props.visibleDate,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MonthPickerTop = __webpack_require__(9);

	var _MonthPickerTop2 = _interopRequireWildcard(_MonthPickerTop);

	var _MonthPickerBody = __webpack_require__(10);

	var _MonthPickerBody2 = _interopRequireWildcard(_MonthPickerBody);
	...
	var MonthPicker = _React2['default'].createClass({
	  ...
	  render: function render() {
	    return _React2['default'].createElement(
	      'div',
	      { className: this.props.className + ' container month' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _YearPickerTop = __webpack_require__(13);

	var _YearPickerTop2 = _interopRequireWildcard(_YearPickerTop);

	var _YearPickerBody = __webpack_require__(14);

	var _YearPickerBody2 = _interopRequireWildcard(_YearPickerBody);

	'use strict';

	var YearPicker = _React2['default'].createClass({
	  ...
	  render: function render() {
	    return _React2['default'].createElement(
	      'div',
	      { className: this.props.className + ' container year' },
	      _React2['default'].createElement(_YearPickerTop2['default'], {
	        visibleDate: this.props.visibleDate,
	        onChangeVisibleDate: this.props.onChangeVisibleDate,
	        className: this.props.className }),
	      _React2['default'].createElement(_YearPickerBody2['default'], {
	        visibleDate: this.props.visibleDate,
	        date: this.props.date,
	        onSelectDate: this._onSelectDate,
	        mode: this.props.mode,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getArrayByBoundary = function getArrayByBoundary(start, end) {
	  var arr = Array.apply(null, Array(end - start));
	...
	var getWeekdaysMin = function getWeekdaysMin() {
	  ...
	  _import2['default'].range(offset).forEach(function (x) {
	...
	var getVisibleDays = function getVisibleDays(month, year, locale) {
	  var offset = _moment2['default']([year, month]).locale(locale).startOf('month').weekday();
	  var previousMonthLength = daysInMonthCount(month - 1, year) + 1; //We need the last number too
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  get: function get(value, location) {
	    return locales[location || "en"][value];
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MonthPickerTop = _React2['default'].createClass({
	  displayName: 'MonthPickerTop',
	  ...
	  render: function render() {
	    ...
	    return _React2['default'].createElement(
	      ...
	      _React2['default'].createElement(
	        ...
	        _React2['default'].createElement(
	          'div',
	          { className: 'button left', onClick: _import2['default'].partial(this.changeYear, year - 1) },
	          '<'
	        ),
	        _React2['default'].createElement(
	          'div',
	          { className: 'button label' + (this.props.fixedMode ? ' fixed' : ''), onClick: this.changeMode },
	          _React2['default'].createElement(
	            'strong',
	            { className: this.props.textClassNames },
	            year
	          )
	        ),
	        _React2['default'].createElement(
	          'div',
	          { className: 'button right', onClick: _import2['default'].partial(this.changeYear, year + 1) },
	          '>'
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InvalidDate = __webpack_require__(16);

	var _InvalidDate2 = _interopRequireWildcard(_InvalidDate);

	var _Picker = __webpack_require__(17);

	var _Picker2 = _interopRequireWildcard(_Picker);
	...
	var MonthPickerBody = _React2['default'].createClass({
	  displayName: 'MonthPickerBody',
	  ...
	  render: function render() {
	    ...
	    var year = this.props.visibleDate.year();
	    var selectedMonth = this.props.date ? this.props.date.month() : -1;
	    var selectedYear = this.props.date ? this.props.date.year() : -1;
	    var months = _moment2['default'].months().map(function (_month, index) {
	      return _React2['default'].createElement(_Picker2['default'], {
	        date: _moment2['default']([year, index, 1]),
	    ...
	    var nColumns = 4;
	    var nRows = 3;
	    var rows = Array.apply(null, Array(nRows)).map(function (n, index) {
	      return _React2['default'].createElement(_Row2['default'], { pickers: months.slice(nColumns * index, nColumns * (index + 1)), mode: _this.props.mode, key: index });
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DayPickerTop = _React2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    var daysMin = _DateUtils2['default'].getWeekdaysMin(this.props.locale).map(function (dayMin, index) {
	      return _React2['default'].createElement(
	        'p',
	    ...
	    var string = this.props.visibleDate.format('MMMM YYYY');
	    var monthValue = string.charAt(0).toUpperCase() + string.slice(1); // first letter always uppercase
	    return _React2['default'].createElement(
	      'div',
	      { className: 'top' },
	      _React2['default'].createElement(
	        ...
	        _React2['default'].createElement(
	          'div',
	          { className: 'button left', onClick: _import2['default'].partial(this.changeMonth, month - 1) },
	          '<'
	        ),
	        _React2['default'].createElement(
	          'div',
	        ...
	        _React2['default'].createElement(
	          'div',
	          { className: 'button right', onClick: _import2['default'].partial(this.changeMonth, month + 1) },
	          '>'
	        )
	      ),
	      _React2['default'].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DayPickerBody = _React2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    var year = this.props.visibleDate.year();
	    var month = this.props.visibleDate.month();
	    var date = this.props.date ? this.props.date.format('DD/MM/YYYY') : undefined;

	    var visibleDays = _DateUtils2['default'].getVisibleDays(month, year, this.props.locale);
	    var days = visibleDays.days.map(function (dayOfMonth, index) {
	      var _date = _this.props.visibleDate.clone();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var YearPickerTop = _React2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _React2['default'].createElement(
	      ...
	      _React2['default'].createElement(
	        ...
	        _React2['default'].createElement(
	          'div',
	          { className: 'button left', onClick: _import2['default'].partial(this.changeYear, year - 10) },
	          '<'
	        ),
	        _React2['default'].createElement(
	          'div',
	          { className: 'button label fixed' },
	          _React2['default'].createElement(
	            'strong',
	            { className: this.props.textClassNames },
	            startDecadeYear,
	        ...
	        _React2['default'].createElement(
	          'div',
	          { className: 'button right', onClick: _import2['default'].partial(this.changeYear, year + 10) },
	          '>'
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var YearPickerBody = _React2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    var visibleYears = _DateUtils2['default'].getVisibleYears(year);
	    var years = visibleYears.years.map(function (_year, index) {
	      ...
	      return _React2['default'].createElement(_Picker2['default'], {
	        date: _moment2['default']([_year, 0, 1]),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InvalidDate = _React2['default'].createClass({
	  displayName: 'InvalidDate',

	  propTypes: {
	    invalidDate: _React2['default'].PropTypes.string
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Picker = _React2['default'].createClass({
	  ...
	  propTypes: {
	    date: _React2['default'].PropTypes.any.isRequired,
	    isSelected: _React2['default'].PropTypes.bool.isRequired,
	    isCurrent: _React2['default'].PropTypes.bool.isRequired,
	  ...
	  render: function render() {
	    ...
	    var classes = 'picker button ' + this.props.mode + (this.props.isCurrent ? ' current' : '') + (this.props.isSelected ? ' selected' : '');
	    return _React2['default'].createElement(
	      'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Row = _React2['default'].createClass({
	  ...
	  propTypes: {
	    pickers: _React2['default'].PropTypes.array.isRequired,
	    mode: _React2['default'].PropTypes.string.isRequired
	  },
